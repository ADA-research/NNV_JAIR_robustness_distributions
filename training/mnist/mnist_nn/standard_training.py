...
if __name__ == "__main__":
    ...
    training_parameters = AttributeDict(learning_rate=0.007, 
                                        weight_decay=0.0001, 
                                        scheduler_step_size=7, 
                                        scheduler_gamma=0.23)
    ...
    experiment_tracker = ExperimentTracker("mnist_nn-standard", Path("./generated"), login=True)
