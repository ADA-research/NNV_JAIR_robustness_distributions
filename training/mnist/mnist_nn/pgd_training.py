...
from ....networks_pytorch.mnist_nn import MNIST_NN
...
if __name__ == "__main__":
    ...
    #in_training_validation_loader = torch.utils.data.DataLoader(in_training_validation_dataset, batch_size=1000, shuffle=True)
    ...
    training_stack = []
    training_stack.append((100, StandardTrainingModule(criterion=criterion, attack=PGDAttack(epsilon_step_size=0.01, number_iterations=40, random_init=True), epsilon=0.3)))
    ...
    experiment_tracker = ExperimentTracker("mnist_nn-pgd", Path("./generated"), login=True)

    experiment_tracker.initialize_new_experiment("new_grad", training_parameters=training_parameters | training_objects)
