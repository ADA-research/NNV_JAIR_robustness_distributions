...
if __name__ == "__main__":
    ...
    training_parameters = AttributeDict(learning_rate=0.00894, 
                                        weight_decay=0.00299, 
                                        scheduler_step_size=5, 
                                        scheduler_gamma=0.893,
                                        attack_epsilon=ATTACK_EPSILON,
                                        batch_size=256)
    ...
    experiment_tracker = ExperimentTracker("mnist_nn-fgsm", Path("./generated"), login=True)
