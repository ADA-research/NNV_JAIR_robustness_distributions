...
if __name__ == "__main__":
    ...
    training_parameters = AttributeDict(learning_rate=0.0016, 
                                        weight_decay=0.00007,
                                        scheduler_step_size=9, 
                                        scheduler_gamma=0.57,
                                        batch_size=128) 
    ...
    #validation_module = StandardTestModule()
    ...
    experiment_tracker = ExperimentTracker("conv_big-standard", Path("./generated"), login=True)
    ...
    pipeline = Pipeline(experiment_tracker, training_parameters, criterion, optimizer)
