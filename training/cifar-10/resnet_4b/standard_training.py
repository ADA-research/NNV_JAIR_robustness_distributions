...
if __name__ == "__main__":
    ...
    """ training_parameters = AttributeDict(learning_rate=0.002, 
                                        weight_decay=0.0065,
                                        scheduler_step_size=8,
                                        scheduler_gamma=0.21,
                                        batch_size=128)  """
    ...
    experiment_tracker = ExperimentTracker("resnet_4b-standard", Path("./generated"), login=True)
