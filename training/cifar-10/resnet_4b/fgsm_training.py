...
if __name__ == "__main__":
    ...
    """ training_parameters = AttributeDict(learning_rate=0.01052,
    ...
    training_stack = [(70, StandardTrainingModule(criterion=criterion, attack=FGSMAttack(), epsilon=training_parameters.attack_epsilon))]
    ...
    experiment_tracker = ExperimentTracker("resnet_4b-fgsm", Path("./generated"), login=True)
