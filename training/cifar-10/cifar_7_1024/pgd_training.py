...
ß∂
    ...
    #train_dataset, test_dataset, validation_dataset = torch.utils.data.random_split(train_dataset, (0.79, 0.2, 0.01))
    ...
    training_stack = []
    training_stack.append((100, StandardTrainingModule(criterion=criterion, attack=pgd_attack, epsilon=8/255)))
    ...
    experiment_tracker = ExperimentTracker("cifar_7_1024-pgd-training", Path("./generated"), login=True)
