...
if __name__ == "__main__":
    ...
    training_parameters = AttributeDict(learning_rate=0.00091, 
    ...
    #validation_dataset = torchvision.datasets.CIFAR10('../../data', train=False, download=False, transform=torchvision.transforms.ToTensor())
    ...
    experiment_tracker = ExperimentTracker("cifar_7_1024-fgsm", Path("./generated"), login=True)

    experiment_tracker.initialize_new_experiment("new_grad_full_data", training_parameters=training_parameters | training_objects)
