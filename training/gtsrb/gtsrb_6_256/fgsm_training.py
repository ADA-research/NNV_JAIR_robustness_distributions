...
def objective(trial):
    ...
    dataset = torchvision.datasets.GTSRB('../../data', split="test", download=False,
                    transform=transform)
...
if __name__ == "__main__":
    ...
    training_parameters = AttributeDict(learning_rate=0.00143, 
                                        weight_decay=0.00024, 
                                        scheduler_step_size=3, 
                                        scheduler_gamma=0.877,
                                        attack_epsilon=ATTACK_EPSILON,
                                        batch_size=BATCH_SIZE)
    ...
    training_stack = [(20, StandardTrainingModule(criterion=criterion, attack=FGSMAttack(), epsilon=training_parameters.attack_epsilon))]
    ...
    experiment_tracker = ExperimentTracker("gtsrb_ffn-fgsm", Path("./generated"), login=True)
