...
if __name__ == "__main__":
    ...
    training_parameters = AttributeDict(learning_rate=0.00163, 
                                        weight_decay=0.00051, 
                                        scheduler_step_size=4, 
                                        scheduler_gamma=0.63,
                                        batch_size=BATCH_SIZE)
    ...
    experiment_tracker = ExperimentTracker("gtsrb_ffn-standard", Path("./generated"), login=True)
