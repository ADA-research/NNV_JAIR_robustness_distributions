...
if __name__ == "__main__":
    ...
    training_parameters = AttributeDict(learning_rate=0.000747, 
                                        weight_decay=0.000044, 
                                        scheduler_step_size=9, 
                                        scheduler_gamma=0.864,
                                        attack_epsilon=ATTACK_EPSILON,
                                        batch_size=BATCH_SIZE)
    ...
    experiment_tracker = ExperimentTracker("gtsrb_network-fgsm", Path("./generated"), login=True)
